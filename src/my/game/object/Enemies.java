...
public class Enemies
{
    ...
    public final Enemy darkPurpleOrbiter = new Enemy(100, 100, 0.25F, 0.25F, 10000000F, new Tail(50, new Color(120, 0, 128)), 100);
    public final Enemy redOrbiter = new Enemy(100, 100, 0.2F, 0.1F, 10000000F, new Tail(25, new Color(255, 0, 0)), 100);
